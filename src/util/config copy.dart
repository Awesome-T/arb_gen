...
//     this.allAtOnce = true,
//   }) {
//     _chekSettingsAndContent(pathToFile);
//   }

//   ///
//   ///
//   static List<String> langs([Map<String, Map<String, String>> languageMap = LANGS]) {
...
//   void _chekSettingsAndContent(String path) {
...
//   ///
//   ///
//   static void checkApiKeyOfService() {
...
//   ///  Если массив `_langCodes` длиннее, и тебе необходимо проверить,
//   /// * что все элементы массива `translateTo` содержатся в массиве `_langCodes`
//   static void checkTargetLangs(List<String> suppurtedLangCodes) {
